 ...
 * @author nacho
 */
public class ChanceViewCard extends javax.swing.JFrame {

    /**
     * Creates new form ChanceViewCard
     */
    public ChanceViewCard() {
        initComponents();
        setSize(675, 300);
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(450, 50, 210, 200);
        ...
        InfoCard.setBounds(10, 110, 440, 130);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChanceViewCard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChanceViewCard().setVisible(true);
            }
        });
    }
